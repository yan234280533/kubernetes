...
func (c *kubeletConfiguration) addFlags(fs *pflag.FlagSet) {
	...
	fs.Int32Var(&c.PlegRelistPeriod, "pleg-relist-period", c.PlegRelistPeriod, "The Period of kubelet round to report the pod status to APIServer, range is [10,100000](ms),default is 1000ms.")
